...
2. Read [rest-scaffold.md](rest-scaffold.md) and follow its Sub-mode B (Test) instructions exactly. Do not re-implement.
3. Return control to the user after `rest-scaffold` reports completion.
