...
def main() -> int:
    ...
    errors += _must_contain(
        ...
        [
            ...
            "**Whitelist — use these exact bracket forms in published cells**",
            ...
            "check_gap_review_bdd_duplicates.py",
            "verify_user_story_gap_review_skill_contract.py",
            "**Salomon Internal Knowledge — future-state framing (mandatory):**",
            "**Salomon Jira index — conditional, WhatsApp keys only:**",
            "**Salomon Slack — conditional, WhatsApp keys only:**",
            "**WhatsApp match flag:**",
            "jira_search_tool",
            "slack_archive_search",
            "XO IMPLEMENTATION AREA SEARCH",
            "## Net-new preamble (Peanut MCP)",
            "### When to invoke Peanut (2WE per-row)",
            "**Invoke Peanut when (and only when):**",
    ...
    errors += _must_contain(
        ...
        [
            ...
            "Salomon bundle",
            "WhatsApp match flag",
            "**PM lens synthesis first**",
            "Salomon Internal Knowledge MCP (PM lens)",
            "Salomon (Knowledge) —",
            "Salomon (Jira index) —",
            "Salomon (Slack) —",
            "jira_search_tool",
