#!/usr/bin/env python3
"""Build slides_spec_v49.json: v30 slide inventory + v30 typography (docs/decks/gcc-pmf-roadmap-v30-typography.md)."""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[2]
OUT = ROOT / "docs" / "decks" / "specs" / "slides_spec_v49.json"
...
def sec(primary: str, secondary: str) -> dict:
    ...
    secondary MUST be a plain string: Slide Deck MCP auto-agenda stringifies run-arrays.
    See 130-pmf-slide-generator.mdc.
    """
    return {
        "master_index": 1,
...
slides.append(
    {
        ...
        "placeholders": {
            ...
            "1": {
                "text": "Workday Recruiting | Gulf Cooperation Council | v49 v30 typography | 22 March 2026"
            },
        },
    }
)
...
slides.append(
    title_only(
        ...
        [
            ...
            {"level": 1, "text": "Report: research/GCC/thematic-analysis/2026-03-22-GCC-PMF-Analysis-v47.md"},
        ...
        alt=True,
        notes="• Ownership and traceability for exec readers.\n\nReferences:\n• research/GCC/thematic-analysis/2026-03-22-GCC-PMF-Analysis-v47.md",
    )
)
...
slides.append(
    {
        ...
        "speaker_notes": "• v47 synthesis; v30-style exec blocks (12pt subheads + bullets).\n\nReferences:\n• 2026-03-22-GCC-PMF-Analysis-v47.md",
    }
)
...
pestel_data = [
    ...
    (
        ...
        "No recruiting feature commitment from this factor in v49; monitor ESG workforce reporting demand.",
        "• N/A.\n\nReferences:\n• N/A",
    ),
    (
        "Legal",
...
slides.append(
    title_only(
        "Customer Ideation Hub | Structured opportunities + qualitative codes (v49)",
        [
