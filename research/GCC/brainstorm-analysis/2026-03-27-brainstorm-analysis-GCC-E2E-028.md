...
- **Completed (UTC):** 2026-03-27T16:35:00Z (analysis run; export timestamp on sheets **03/11/2026 9:59 AM**)

---

## Executive summary

- **9,922** P&T ideas sit under the **Talent Acquisition** product-area filter in this export. On **Sentiment: Product Area (Model Topics)** (Talent Acquisition aggregate), **Negative** band shows **% Parent ≈ 0.527** with **Volume 5,233** and modelled sentiment **≈ -1.918**; **Positive** band **% Parent ≈ 0.395**, **Volume 3,917**, **≈ +1.964**; **Neutral** band **Volume 8,530**, sentiment **≈ -0.0009**; aggregate **Talent Acquisition** row **N = 9,922**, overall sentiment **≈ -0.164** (dashboard semantics: confirm field definitions before executive numeric claims).
...
- **Idea Question Responses** (first rows ingested in the scratch dump this run) includes recurring themes such as **per-question job application questionnaires**, **comp package / job catalog** adjustments, and **learning / certification** tracking gaps; keyword scans across the **2,000-row-per-sheet** dump cap reinforce configurability, **requisition**, **application**, and **candidate** language — overlap with **105** GCC narratives is **possible** but **not proven** by this file alone.
