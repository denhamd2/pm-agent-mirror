# GCC PMF Thematic Analysis (v3 — Fresh Run)
...
**Phase 0:** Filtered Opportunity Detail.xlsx for GCC (Saudi, UAE, Qatar, Kuwait, Bahrain, Oman, KSA, MENA) — 2 explicit GCC gaps identified  
...
- **PESTEL:** GCC app market growth 2.6% YoY vs 0.5% globally; WhatsApp 3.2B users, 83% daily use
...
### Social
- **WhatsApp:** 3.2B users globally; 83% daily use. GCC app market growth 2.6% YoY vs 0.5% globally. P1, P2 cite WhatsApp as essential for candidate communication.
...
### Technological
- **Qiwa, GOSI, Mudad:** Saudi government portals for work permits, social insurance. Work permit classification (High-Skilled, Skilled, Basic) effective July 2025.
...
- **KSA Interview Regulations (May 2025):** 3-day notice; panel ≥2 Saudi nationals (1 HR specialist); non-Saudi ≤50%; prohibited questions; 30-day outcome notification (Mondaq, Al Tamimi).
...
**Top 10 Recruiting gaps by severity (global):** Candidate Job Application Flow, Career Sites, Interviews, Communications, Screening and Assessments, Candidates and Prospects.
...
**Report Generated:** 18 March 2026 (v3 — E2E Pipeline)  
**Analyst:** PMF Research Specialist  
---
...
- Saudi Nitaqat 2026–2028: Mondaq (Al Tamimi), Envoy Global — accurate; 340,000 jobs localised
- UAE Emiratisation: AED 108,000 per missing Emirati; 8%/10% targets — accurate
- KSA Interview Regulations (May 2025): Mondaq — 3-day notice, ≥2 Saudi nationals (1 HR), non-Saudi ≤50% — accurate
...
**Review Status:** Draft — Legal validation complete
