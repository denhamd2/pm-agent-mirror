...
- **Competitive:** **101** point-in-time scan **GCC-E2E-025** + **gcc-competitive-matrix.md** changelog **2026-03-27 - GCC-E2E-025 - Refresh** (no additional web competitor research by **120**).
...
- **Mission ID (Fresh pass attestation):** **GCC-E2E-025**
...
**Matrix:** [`research/competitive/matrices/gcc-competitive-matrix.md`](../../competitive/matrices/gcc-competitive-matrix.md) — **changelog** entries **GCC-E2E-025 (26 March 2026)** and **GCC-E2E-025 refresh (27 March 2026)** document **DA26** thread **`94b16002-e468-4042-a1eb-8757181f8111`**: reconciles vs **DA25** on **SMS** (**Native** UAE/Saudi via standard SMS/Twilio framework), **scheduling** (**Native** predefined and live M365/Google self-scheduling **when Workday Scheduling SKU is licensed**; **not** included in base Recruiting), **MOHRE** and **nationalisation OOTB dashboards** (**Workaround**). **Aligned** with **DA25/26** on **first-party WhatsApp** (**True Gap**), **Qiwa/Mudad recruiting connectors** (**True Gap**), **semantic AI without add-ons** (**True Gap**), **multipost without Broadbean** (**True Gap**), **Arabic complex Workday Docs** (**Workaround**), **grid** (**Native**).

**Point-in-time report:** [`research/competitive/gcc/gcc-competitive-scan-2026-03-26-GCC-E2E-025.md`](../../competitive/gcc/gcc-competitive-scan-2026-03-26-GCC-E2E-025.md) (filename per mission; **updated 27 March 2026** with **DA26** refresh)
...
- **Enablement rule:** **Triangulate** **DA20 through DA26** for **scheduling**, **SMS**, and **nationalisation** — **DA26** **differs** from **DA25** on multiple rows; **PS** + **tenant UAT** **before** **customer** **commitments**; **do not** conflate **Workday Scheduling SKU** entitlement with **base Recruiting** alone.
...
- **DA26 parity table (high level):** **Native:** configurable candidate grid; predefined-slot and live-calendar self-scheduling **with Workday Scheduling SKU**; SMS UAE/Saudi via standard framework with Twilio. **Workaround:** MOHRE reporting OOTB; OOTB nationalisation programme dashboards; Arabic RTL complex Workday Docs (with caveats). **True Gap:** first-party WhatsApp in core Recruiting UI; native packaged Qiwa/Mudad recruiting connectors; semantic AI match without Skills Cloud / HiredScore / ESI; multipost to regional boards without Broadbean.

---

## 106 inputs (Step 2.5)

**Report:** [`research/GCC/brainstorm-analysis/2026-03-27-brainstorm-analysis-GCC-E2E-025.md`](../brainstorm-analysis/2026-03-27-brainstorm-analysis-GCC-E2E-025.md)

- **Mission:** GCC-E2E-025; **P&T Idea Results** Qualtrics export (**N = 9,922** ideas, TA filter). **Regional caveat:** Global dashboard; **no GCC tokens** in **Idea Question Responses** cells; themes are **global Talent Acquisition** pressure to cross-check with **105**, not GCC market fit alone.
...
**Report:** [`research/GCC/win-loss-analysis/2026-03-27-win-loss-analysis-GCC-E2E-025.md`](../win-loss-analysis/2026-03-27-win-loss-analysis-GCC-E2E-025.md)
...
**Product implication:** Workday must support **defensible, auditable tracking and reporting** of **nationalisation-relevant** attributes and **manager-ready** views, while **sales and PS** use **DA25–DA26** language to avoid **over-claiming** a single **OOTB** “Saudization product” where **DA26** classifies **Workaround**-style **custom reports and dashboards** for nationalisation OOTB — **triangulate** before bake-offs.
...
**Product implication:** **Mobile-first apply** and **multi-channel** comms (SMS per **DA26** Native framing for UAE/Saudi, email, **verified** Teams-style identity) must coexist with **optional** WhatsApp paths **where licensed** (**Paradox** per **101**).
...
This section **summarises** [`gcc-competitive-scan-2026-03-26-GCC-E2E-025.md`](../../competitive/gcc/gcc-competitive-scan-2026-03-26-GCC-E2E-025.md) and the **GCC-E2E-025** changelog in [`gcc-competitive-matrix.md`](../../competitive/matrices/gcc-competitive-matrix.md) (**v1.17** header; **27 March 2026** refresh).
...
- **Workday:** **Paradox** **Jan 2026** conversational ATS newsroom; **Skills Cloud** public pages for **match** story; **DA26** parity row for **Native / Workaround / True Gap** (see **101** table).

### Workday SWOT (GCC-oriented, from 101 synthesis)

| | **Strengths** | **Weaknesses** |
|---|----------------|-----------------|
| **Internal** | • Enterprise **grid** (**Native**, **DA26**)\n• **Workday Scheduling SKU**: predefined and live-calendar self-scheduling when **licensed** (**not** base Recruiting alone)\n• **Paradox** path for conversational journeys when **licensed**\n• **Skills Cloud** / **HiredScore** for **AI depth** when **activated**\n• **GCC SMS** (**Native** per **DA26** via standard framework + Twilio; **validate** tenant routing) | • **True Gap:** **first-party WhatsApp** in **core** UI; **Qiwa/Mudad recruiting** connectors; **semantic match** without add-ons; **multipost** without **Broadbean**\n• **Workaround** positioning for **nationalisation** and **MOHRE** dashboards vs **regional OOTB** competitor narratives\n• **Arabic** complex **Docs** (**Workaround** with caveats)\n• **Deployment Agent drift** across **DA25** / **DA26** on **SMS**, **scheduling**, **nationalisation** — **mandate** **PS + UAT** per **101** |
...
| **T3 Scheduling and compliance-aware orchestration** | *No SME* | **P1** external scheduling + KSA rules; **P2** Outlook easier than Workday | **Interviews** row volume (476) | No Gulf rows | **2/3** strong + **106** | P3 indirect; **101 DA26** **Native** scheduling **with Scheduling SKU** **vs** **customer** **Outlook** preference | **High** |
...
| **T5 Nationalisation and local compliance reporting** | *No SME* | **P1** quotas; **P2** penalties + **OOB** ask; **P3** franchise **Excel** | Not GCC-specific in cells | No Gulf rows | **P1–P2** strong vs **P3** lower GCC priority | **101:** **DA26** **Workaround** **nationalisation/MOHRE** **vs** **DA25** **True Gap** on some rows | **High** |
| **T6 Omnichannel comms and candidate journey** | *No SME* | **P1–P2** WhatsApp; **P2** Phenom; **P3** ban official WhatsApp | **Communications and Notifications** (1,452) | No Gulf rows | **Channel importance** converges; **policy** diverges | **P3** vs **P1/P2**; **DA26** **Native** **GCC SMS** **vs** **101** **True Gap** **WhatsApp** | **High** |

**Triangulation note:** **4/4** agreement is **not** claimed where **107** is empty for Gulf; strongest confidence = **Customer + 101 + 106** (hypothesis) + **PESTEL**. **Deployment Agent** classifications for **scheduling**, **SMS**, and **nationalisation** **vary by thread** (**DA25** **vs** **DA26**) — **mandate** **PS + UAT** per **101**.
...
**Product roadmap impact:** **Semantic search** roadmap with **Skills Cloud / HiredScore** **entitlements** explicit; **explainability** and **human review** (**060**); **similar candidate** surfacing on req. **101** classifies **semantic AI without add-ons** as **True Gap** (**DA26**).
...
**Product roadmap impact:** **In-product scheduling** with **clear entitlement** story: **DA26** states **Native** for **predefined-slot and live M365/Google self-scheduling** **when Workday Scheduling SKU is licensed** (separate SKU, **not** base Recruiting). **Configurable warnings** (not false legal claims); **panel metadata** capture; **PS + UAT** before absolute **GTM** claims — **triangulate** **DA25** **vs** **DA26**.
...
**Product roadmap impact:** **Faster** safe configuration change patterns; **RTL font/template** **hardening** with **customer UAT**; **in-flow** document collection. **101** **DA26**: **Arabic RTL complex Workday Docs** = **Workaround** with caveats (not **True Gap** in **DA26** framing).
...
**Product roadmap impact:** **First-class** **nationalisation** dimensions and **report packs** where **product** chooses to invest; **honest** **Workaround** story per **DA26** for **OOTB nationalisation** and **MOHRE** dashboards **vs** **DA25** **True Gap** on those rows — **triangulate** in **GTM**; **PS** patterns for **custom** dashboards.
...
**PMF impact:** **High** — **101** **True Gap** **first-party** WhatsApp vs **Paradox** **where licensed**; **DA26** adds **Native** framing for **GCC SMS** via standard product with **Twilio** (validate per tenant).

**Product roadmap impact:** **Paradox** **activation** economics (**P2** cost narrative); **SMS** (**DA26**), **email**, **Teams**-aligned **verified** outreach; **mobile** apply and **branding** / **redirect** reduction.
...
| **Schedule** | **Outlook** easier; **KSA** rules | 🔴 HIGH | External tool | **P1**, **P2** | **Scheduling SKU** + **compliance hints**; **UAT** **DA26** **vs** **DA25** |
| **Offer** | **Rigidity**; **Arabic** **Docs** | 🔴 HIGH | Offline contracts | **P1**, **P3** | **Agile** config + **RTL** **QA** (**DA26** **Workaround**) |
| **Comply** | **Nationalisation** **reporting** | 🔴 HIGH | Custom fields / Excel | **P1**, **P2**, **P3** | **OOB** **depth** vs honest **Workaround** (**DA26**) |
...
- **DA26 vs DA25:** **SMS**, **scheduling** (Scheduling SKU), **MOHRE**, and **nationalisation OOTB** rows **shift** classification; **bake-offs** must **document** **which** **Deployment Agent** **thread** **informed** **each** **claim** and **prefer** **tenant** **UAT** over **single-thread** **absolutes**.
...
5. **First-party WhatsApp in core Recruiting UI** — Address **101** **True Gap** where **customers** and **policy** allow; pair with **Paradox**, **SMS** (**DA26** Native framing for GCC), and **verified** channels for **restricted** enterprises (**P1**, **P2**, **P3** divergence; **101**).
...
7. **Offer letter and document automation** — Shorten **configuration** **cycle** risk; **UAT** **Arabic** **RTL** **Workday Docs** end-to-end (**Workaround** per **DA26**); structured **candidate** **document** **upload** in flow (**P1**, **P3**).
8. **Career site experience and mobile apply** — Reduce **Phenom→Workday** **redirect** **friction**; improve **mobile** **density** for **bilingual** segments (**P2**); **multipost** without **Broadbean** = **True Gap** per **DA26**.
...
| 5 | First-party WhatsApp in core Recruiting UI | Address the True Gap where customer policy allows; leverage GCC SMS Native framing per DA26 where applicable; maintain strong email and verifiable enterprise channels for policy-constrained tenants; activate Paradox where licensed. |
...
| 7 | Offer letter and document automation | Reduce configuration lead-time risk for out-of-band grades and roles; UAT Arabic RTL Workday Docs pipelines end-to-end (Workaround per DA26 with caveats); enable structured in-flow candidate document upload by category. |
| 8 | Career site experience and mobile apply | Improve branding and reduce multi-hop Phenom to Workday apply redirect friction; optimise handheld apply for professional English and operational Arabic segments; multipost without Broadbean: True Gap per DA26 — document Broadbean partnership expansion where needed. |
...
- `research/GCC/brainstorm-analysis/2026-03-27-brainstorm-analysis-GCC-E2E-025.md`  
- `research/GCC/win-loss-analysis/2026-03-27-win-loss-analysis-GCC-E2E-025.md`  
- `research/competitive/matrices/gcc-competitive-matrix.md` (changelog GCC-E2E-025, **27 March 2026** refresh)  
- `research/competitive/gcc/gcc-competitive-scan-2026-03-26-GCC-E2E-025.md`  
...
| DA26-Scheduling-SKU-Native | 101 | Workday Scheduling SKU |
| DA26-GCC-SMS-Native | 101 | Twilio UAE/Saudi |
...
- **101 (Step 1):** `research/competitive/gcc/gcc-competitive-scan-2026-03-26-GCC-E2E-025.md`  
