# GCC PMF Thematic Analysis (v38 — Fresh Braun & Clarke 6-Phase)
...
This v38 pass **re-familiarised** with all GCC customer transcripts and `filtered_gcc_opps.csv` and **re-validates** six PMF themes for Workday Recruiting in the region. **Nationalization and compliance tracking** remains the strongest cross-customer signal: P1 (Accenture) ties hiring targets to Emiratisation, Saudization, and Kuwaitisation in Workday; P2 (Baker Hughes) describes penalties for missing localization mandates and gaps versus US/UK OOB diversity patterns.

**Reporting and dashboards** converge across interviews (P1 in-product readability; P2/P3 PowerBI; franchise-country manual cuts for P3). **Interview scheduling** fragments: external schedulers (P1), Outlook perceived as lighter than Workday (P2), and Win/Loss **PG-00009165** documents GCC populations cannot rely on Outlook/MS Teams for scheduling or HiredScore. **KSA-specific rules** from P1 (three-day notice, panel composition, documented consent if shortening notice) remain the compliance UX bar for any embedded scheduler (e.g. Paradox).
...
- Full re-read of P1, P2, P3 transcripts and CSV rows (v38 run, 19 March 2026)
...
- This document; deck `GCC_Recruiting_PMF_Roadmap_v38.pptx`
...
**Report generated:** 19 March 2026 (v38 — GCC E2E Step 1)  
**Analyst:** PMF Research Specialist (120-pmf-thematic-analysis)
