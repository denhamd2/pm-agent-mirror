...
**Last Updated**: 5 April 2026 | **Version**: v1.25 | **Maintainer**: Agent 101  
...
Workday Recruiting + Core + Talent is the **platform play**. Bayzat and similar vendors are the **GCC-first bundle play**. HiBob is the **modern mid-market HCM** with growing regional presence. Zoho Recruit is the **value ATS** often combined with Zoho People in cost-sensitive segments. **GCC-E2E-034** adds **watch-list** profiles for **iCIMS**, **Keka**, **Darwinbox**, **Bayt.com** sourcing, and **board** aggregators (**Laimoon** / **GulfTalent** fetch TBD) — see **Additional GCC-relevant competitors** section.
...
• **GCC-E2E-034 (5 April 2026):** **New** Deployment Agent thread **`cca9b0a2-9a51-432c-aafa-61576aeb61dd`** (**DA34**) **Pattern** **1a** **fresh** **scan** **`research/competitive/gcc/gcc-competitive-scan-2026-04-05-GCC-E2E-034.md`**. **Strategic** **context** **`research/GCC/strategy-context-2026-04-05-GCC-E2E-034.md`** **(Q2** **P1–P3;** **March** **2026** **TA** **PDF** **extracted** **in** **099** **—** **WhatsApp** **EA** **January** **2026,** **triangulate** **with** **DA).** **Drift** **vs** **DA33:** **Live** **M365/Google** **calendar** **read** **for** **candidate** **self-scheduling** **True** **Gap** **(predefined** **slots** **only** **per** **DA34)** **vs** **DA33** **Native** **with** **Workday** **Scheduling** **SKU**; **multipost** **without** **Broadbean** **True** **Gap** **vs** **DA33** **Workaround**; **semantic/AI** **match** **without** **Skills** **Cloud** **True** **Gap** **vs** **DA33** **Workaround** **(keyword** **core)**; **nationalisation** **executive** **dashboards** **Workaround** **(custom** **analytics** **per** **DA34)** **vs** **DA33** **True** **Gap** **OOTB**; **predefined** **self-scheduling** **Native** **and** **standard** **flow** **does** **not** **require** **Workday** **Scheduling** **SKU** **per** **DA34** **—** **reconcile** **DA26–DA33**. **Aligned** **with** **DA33/34** **on** **SMS** **True** **Gap** **(UAE/Saudi** **not** **on** **WMS** **supported-country** **narrative** **per** **DA34)**, **WhatsApp** **True** **Gap**, **Qiwa/Mudad** **True** **Gap**, **MOHRE** **True** **Gap** **OOTB**, **grid** **Native**, **Arabic** **complex** **RTL** **Workday** **Documents** **Workaround**. **Citations** **array** **empty**. **Triangulate** **DA20** **through** **DA34**; **PS** **+** **UAT** **before** **customer** **commitments**.  
...
|------------------|------------------|----------------|------------------------|-----------------------------------|-------------|---------------------------|------|------|
| WhatsApp candidate comms | Native or packaged | **GCC-E2E-034** **DA34:** **True** **Gap** **first-party** **core** **UI** **(third-party** **typical)**. **GCC-E2E-030** **DA31** **/** **GCC-E2E-031** **DA32** **/** **GCC-E2E-032** **DA33:** **True** **Gap** **first-party** **core** **UI**; **GCC-E2E-029** **DA30** **Workaround** (**Paradox** **/** **third-party**); **DA28/29** **True** **Gap** **wording** **—** **triangulate** **DA28–DA34** **in** **120**; **Paradox** (Jan 2026 newsroom) + **Studio** **paths** | Paradox; Studio + CPaaS | Activate and configure per **Deployment Agent** + **Paradox** docs | **GCC SMS:** **triangulate** **DA23** **/** **DA29** **/** **DA30** **/** **DA31** **/** **DA32** **/** **DA33** **/** **DA34** (**DA33** **/** **DA34** **True** **Gap** **native** **WMS** **for** **UAE/Saudi** **vs** **DA31/32** **Workaround** **third-party** **SMS** **+** **integration**); **PS + UAT** | @functional-knowledge (integrations) **section TBD** | TBD | TBD |
| Core AI job-candidate match (no HiredScore) | “No native AI match” | **GCC-E2E-034** **DA34:** **True** **Gap** **advanced** **semantic/AI** **without** **Skills** **Cloud** **(** **core** **keyword** **/** **structured** **matching** **per** **DA34)** **vs** **GCC-E2E-032** **DA33** **Workaround** **keyword** **framing**. **Also:** **Candidate Skills Match** **Skills** **Cloud** **+** **ML** **per** **GCC-E2E-019**; **GCC-E2E-023** **DA23** **True** **Gap** **without** **Skills** **Cloud** **—** **triangulate** **buyer** **“AI”** **language** **in** **120**; **HiredScore** separate SKU | **HiredScore** for deeper grading / rediscovery (separate SKU) | Confirm **Skills Cloud** entitlement; disclose vs **HiredScore** / **Winston** / **Zia** | **DA33** **vs** **DA34** **on** **keyword-only** **vs** **True** **Gap** **semantic** **—** **PS** **+** **deal** **language** | @functional-knowledge **TBD** | TBD | TBD |
| Interview self-scheduling + live calendars | Full automation | **GCC-E2E-034** **DA34:** **True** **Gap** **live** **read** **of** **M365/Google** **(** **predefined** **slots** **only** **)**; **predefined** **self-scheduling** **Native** **without** **Workday** **Scheduling** **SKU** **per** **DA34** **item** **(9)** **—** **drift** **vs** **DA33** **Native** **+** **Scheduling** **SKU** **for** **live** **read**. **GCC-E2E-023** **DA23:** **True** **Gap** **live** **calendar** **read**. **GCC-E2E-021/022** **DA21/22:** **Native** **(** **older** **threads** **)**. **Do not** commit without **PS** + **UAT** | Recruiter-led scheduling has calendar integration | Document in bake-offs; **Paradox** if conversational scheduling is decisive | **Multi-thread** **drift** **DA20** **through** **DA34** | **TBD** | TBD | TBD |
| Qiwa / nationalisation reporting | Statutory dashboards | **GCC-E2E-034** **DA34:** **Qiwa/Mudad** **True** **Gap**; **MOHRE** **True** **Gap** **OOTB**; **nationalisation** **executive** **dashboards** **Workaround** **(custom** **analytics)** **—** **drift** **vs** **GCC-E2E-032** **DA33** **True** **Gap** **OOTB** **on** **nationalisation** **dashboards**. **GCC-E2E-030** **DA31** **/** **GCC-E2E-031** **DA32:** **MOHRE** **+** **nationalisation** **Workaround**. **Triangulate** **DA21–DA34** **in** **120** | Often **native** narrative (regional) | Custom fields, reports, integrations | **Validate** with Deployment Agent + **PS** | **DA33** **/** **DA34** **split** **on** **nationalisation** **OOTB** **vs** **custom** **dashboards** | @functional-knowledge (reporting) **section TBD** | TBD | TBD |
| Multipost to regional boards without Broadbean | Native multipost | **GCC-E2E-034** **DA34:** **True** **Gap** **(** **third-party** **e.g.** **Broadbean** **required** **)** **vs** **GCC-E2E-032** **DA33** **Workaround** **(Broadbean-class)**. **Triangulate** **DA28–DA34** | Regional boards often direct | Broadbean partnership (`011-product-context.mdc`); custom RaaS | **PS** **+** **partner** **confirmation** **per** **board** | @functional-knowledge **TBD** | TBD | TBD |
...
- **Core ATS**: reqs, pipeline, automation; **Mar 2026** What’s New: **Profile Summary and Skill Sets in Applications** (`zoho.com/recruit/whats-new.html?lang=en`); **Feb 2026**: job alerts, auto-trigger screening bot, built-in telephony, shared ownership; **semantic** match **%** + **Zia Matches** (vendor blogs / AI hub).  
...
- **GCC-E2E-034 (5 April 2026):** **`whats-new.html?lang=en`** **fetched** **—** **2026** **Mar** **+** **Feb** **+** **Jan** **(** **Mar:** **Profile** **Summary** **/** **Skill** **Sets** **in** **Applications** **)**, **help** **topic** **in** **scan** **citations**; **Deployment** **Agent** **DA34**; scan: **`research/competitive/gcc/gcc-competitive-scan-2026-04-05-GCC-E2E-034.md`**.  
...
- **GCC-E2E-034 (5 April 2026):** **news.sap.com** **Mar** **2026** **SmartRecruiters** **+** **HR** **Brew** **+** **SAP** **demo** **series** **(** **soldemoseries-202603-sma** **)** **re-cited**; **Deployment** **Agent** **DA34**; **`research/competitive/gcc/gcc-competitive-scan-2026-04-05-GCC-E2E-034.md`**.  
...
- **GCC-E2E-034 (5 April 2026):** **26A** **recr** **index** **+** **Recruiting** **Booster** **doc** **+** **26B** **recruiting** **feature** **summary** **URL** **(** **readiness** **docs** **)** **in** **scan**; **Deployment** **Agent** **DA34**; **`research/competitive/gcc/gcc-competitive-scan-2026-04-05-GCC-E2E-034.md`**.  
...
### Additional GCC-relevant competitors (GCC-E2E-034 snapshot)

*Point-in-time additions to the default matrix roster (**Bayzat**, **HiBob**, **Zoho** + enterprise **SAP** / **Oracle**). Full profiles and URLs: **`research/competitive/gcc/gcc-competitive-scan-2026-04-05-GCC-E2E-034.md`**.**

#### iCIMS
- **GCC / MENA:** UAE logo lists (third-party aggregators) and **KSA** customer story (**Servier Saudi Arabia** on `icims.com`). **Spring 2026** platform update referenced in trade summaries — **verify** release notes per deal.  
- **Workday angle:** **Suite** **vs** **best-of-breed** **ATS**; **integration** **tax** **and** **governance**.

#### Keka HR
- **Regional:** **UAE** **/** **GCC** **marketing** **site** **(** **`keka.com/ae`** **)** **for** **ATS** **and** **recruitment** **management**; **Arabic** **+** **mobile** **narrative**; **HR** **Playbook** **2026** **research** **asset**.

#### Darwinbox
- **GCC:** **Payroll** **for** **GCC** **product** **page** **(** **UAE** **,** **KSA** **,** **OM** **,** **QA** **,** **BH** **,** **KW** **)** **and** **DIFC** **office** **press** **(** **2022** **)**; **recruitment** **LP** **with** **AI** **hiring** **features**.

#### Bayt.com (board / sourcing, not full ATS)
- **Employers:** **business.bayt.com** **—** **AI** **posting** **,** **CV** **database** **,** **WhatsApp** **/** **chat** **contact** **claims** **(** **verify** **live** **pages** **)**. **Job** **distribution:** **Broadbean** **path** **per** **product** **context** **(** **011** **)** **—** **do** **not** **propose** **native** **board** **builds**.

#### Laimoon / GulfTalent (watch list)
- **GCC-E2E-034:** **No** **dated** **April** **2026** **press** **captured** **in** **automated** **search** **—** **direct** **URL** **fetch** **recommended** **next** **refresh**.
...
**GCC-E2E-034 (5 April 2026)** — **Pattern 1a** baseline scan (Step 4); **strategic** **context** `research/GCC/strategy-context-2026-04-05-GCC-E2E-034.md` **+** **fresh** web pass (**SAP** **/** **Oracle** **26B**, **Zoho** **Mar** **2026**, **Bayt**, **iCIMS**, **Keka**, **Darwinbox**) **+** **new** Deployment Agent thread (**no** **`threadId`**).  
- **Thread:** `cca9b0a2-9a51-432c-aafa-61576aeb61dd` (**DA34**)  
- **Drift vs DA33:** **Live** **M365/Google** **calendar** **read** **for** **self-scheduling** **True** **Gap** **(predefined** **slots** **only)** **vs** **DA33** **Native** **+** **Workday** **Scheduling** **SKU**; **multipost** **without** **Broadbean** **True** **Gap** **vs** **DA33** **Workaround**; **semantic/AI** **without** **Skills** **Cloud** **True** **Gap** **vs** **DA33** **Workaround** **(keyword** **core)**; **nationalisation** **executive** **dashboards** **Workaround** **vs** **DA33** **True** **Gap** **OOTB**; **predefined** **self-scheduling** **Native** **without** **Scheduling** **SKU** **per** **DA34** **—** **reconcile** **DA26–DA33**. **Aligned** **with** **DA33/34** **on** **SMS** **True** **Gap** **(UAE/Saudi** **not** **on** **WMS** **supported-country** **narrative)**, **WhatsApp** **True** **Gap**, **Qiwa/Mudad** **True** **Gap**, **MOHRE** **True** **Gap** **OOTB**, **grid** **Native**, **Arabic** **complex** **RTL** **Workday** **Documents** **Workaround**. **Citations** **array** **empty** on MCP response.  
- **Scan:** `research/competitive/gcc/gcc-competitive-scan-2026-04-05-GCC-E2E-034.md`
...
**v1.25** – 5 April 2026  
- **GCC-E2E-034 (Pattern 1a baseline — Step 4):** New point-in-time scan **`research/competitive/gcc/gcc-competitive-scan-2026-04-05-GCC-E2E-034.md`**. **Strategic** **context** **`research/GCC/strategy-context-2026-04-05-GCC-E2E-034.md`** **(Q2** **P1–P3;** **March** **2026** **TA** **PDF** **extracted)** + **fresh** web pass (**SAP** **SmartRecruiters** **/** **events**, **Oracle** **26B** **recr** **summary**, **Zoho** **Mar** **2026** **What’s** **New**, **Bayt** **employers**, **iCIMS** **KSA** **story**, **Keka** **AE**, **Darwinbox** **GCC**) + **new** Deployment Agent thread **`cca9b0a2-9a51-432c-aafa-61576aeb61dd`** (**DA34**). Matrix: **v1.25** **header**; **Key** **Threats** **GCC-E2E-034** **DA34** **bullet** (**scheduling** **live** **calendar** **read** **/** **multipost** **/** **semantic** **AI** **/** **nationalisation** **dashboard** **drift** **vs** **DA33**); **Workday** **competitive** **response** **table** **DA28–DA34**; **Bayzat** **/** **HiBob** **/** **Zoho** **/** **SAP** **/** **Oracle** **E2E-034** **lines**; **new** **section** **Additional** **GCC-relevant** **competitors**; **point-in-time** **lists** **append** **E2E-034**; **Deployment** **Agent** **log** **GCC-E2E-034**; **Changelog** **section** **GCC-E2E-034**.
...
## Changelog: 2026-04-05 - GCC-E2E-034 - GCC E2E Baseline Scan (Step 4)

- **Scan artifact:** `research/competitive/gcc/gcc-competitive-scan-2026-04-05-GCC-E2E-034.md`  
- **Mission:** GCC-E2E-034  
- **Matrix version:** v1.25  
- **Delta:**  
  - **Strategic context:** `research/GCC/strategy-context-2026-04-05-GCC-E2E-034.md` — **P1** GCC readiness (WhatsApp, SMS, nationalisation, Arabic, Broadbean boards); **P2** AI matching / HiredScore beta; **P3** ATS parity; **March 2026** TA PDF extracted (**WhatsApp** EA January 2026 — **triangulate** with Deployment Agent).  
  - **Fresh web pass:** **5** **April** **2026** — **SAP** **(** **news.sap.com** **Mar** **2026**, **HR** **Brew**, **events.sap.com** **demo** **series** **)**, **Oracle** **(** **26A** **recr** **index**, **Recruiting** **Booster** **doc**, **26B** **recruiting** **feature** **summary** **)**, **Zoho** **`whats-new.html?lang=en`** **(** **Mar** **2026** **Profile** **Summary** **in** **Applications** **)**, **Bayt** **(** **business.bayt.com** **employer** **narrative** **)**, **iCIMS** **(** **Servier** **Saudi** **Arabia** **success** **story** **)**, **Keka** **(** **`keka.com/ae`** **ATS** **)**, **Darwinbox** **(** **GCC** **payroll** **+** **recruitment** **LP** **+** **DIFC** **press** **)**, **Bayzat** **(** **Zawya** **Mar** **2026** **re-cite** **in** **scan** **)**. **Laimoon** **/** **GulfTalent:** **no** **dated** **hits** **this** **pass** **(** **watch** **list** **)**.  
  - **Deployment Agent (new thread `cca9b0a2-9a51-432c-aafa-61576aeb61dd`, DA34):** **True** **Gap** **live** **M365/Google** **calendar** **read** **for** **self-scheduling** **(** **predefined** **slots** **only** **)** **vs** **DA33** **Native** **+** **Scheduling** **SKU**; **True** **Gap** **multipost** **without** **Broadbean** **vs** **DA33** **Workaround**; **True** **Gap** **semantic/AI** **without** **Skills** **Cloud** **vs** **DA33** **Workaround** **keyword** **framing**; **Workaround** **nationalisation** **executive** **dashboards** **vs** **DA33** **True** **Gap** **OOTB**; **Native** **predefined** **self-scheduling** **without** **Scheduling** **SKU** **per** **DA34** **item** **(9)**. **Aligned** **with** **DA33/34** **on** **SMS** **True** **Gap** **(UAE/Saudi)**, **WhatsApp** **True** **Gap**, **Qiwa/Mudad** **True** **Gap**, **MOHRE** **True** **Gap** **OOTB**, **grid** **Native**, **Arabic** **complex** **RTL** **Documents** **Workaround**. **Citations** **array** **empty**.  
  - **Matrix:** **v1.25** **header**; **Key** **Threats** **GCC-E2E-034**; **competitive** **response** **table** **DA34** **triangulation**; **Additional** **GCC-relevant** **competitors** **section** **(** **iCIMS** **,** **Keka** **,** **Darwinbox** **,** **Bayt** **,** **watch** **list** **)**, **profile** **E2E-034** **lines**, **Deployment** **Agent** **log** **GCC-E2E-034**, **point-in-time** **lists** **append** **E2E-034**.
