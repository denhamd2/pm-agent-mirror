...
- **`specs/`** – Slide Deck MCP JSON (`slides_spec*.json`). Agents and scripts write new specs here; see [`scripts/slide_specs_dir.py`](../../scripts/slide_specs_dir.py) (`SLIDE_SPECS_DIR`).
