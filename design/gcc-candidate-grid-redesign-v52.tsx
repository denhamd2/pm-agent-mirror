...
/**
 * GCC Candidate Grid redesign v52 — GCC-E2E-011, HITL #5.
 * PRD: docs/prds/gcc-candidate-grid-redesign-v52-prd.md
 * Discovery: design/gcc-candidate-grid-redesign-v52-discovery-brief.md (Final Verdict: APPROVED).
 * Copy: design/gcc-candidate-grid-redesign-v52-copy-review-319.md
 */
...
const COPY = {
  ...
  searchHint: 'Use AND, OR and NOT between terms.',
  booleanSearchTips: 'Boolean search tips',
  errorCv: "We couldn't load this CV. Open it in a new tab or try again.",
  errorMissing: "We couldn't find this candidate. Return to the grid or refresh the page.",
  errorGrid: "We couldn't load candidates. Check your connection and try again.",
  emptyGrid: 'No candidates match your filters.',
...
export const GccCandidateGridRedesignV52: React.FC = () => {
  const [queryFlags] = useState(readV52QueryFlags);
      ...
      >
        ...
        {queryFlags.gridError ? (
          ...
          <>
            ...
            <Box marginBottom="m">
              <label htmlFor="v52-search" style={{ display: 'block', marginBottom: space.xxs }}>
...
export default GccCandidateGridRedesignV52;
