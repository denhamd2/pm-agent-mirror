# Discovery & Design Brief: Candidate Grid Redesign (v50)

**PRD:** `docs/prds/gcc-candidate-grid-redesign-v50-prd.md` (post–Red Team revision)  
**Red Team:** `docs/prds/gcc-candidate-grid-redesign-v50-prd-red-team-review.md`  
**Research:** `research/GCC/thematic-analysis/2026-03-22-GCC-PMF-Analysis-v50.md` — E2E recommendation **#5** (candidate grid / single-pane recruiter UX)  
**CI:** `research/competitive/gcc/e2e-ci-brief-candidate-grid-redesign-2026-03-22.md`  
**Created:** 22 March 2026  
**Agent:** 315 — Prototype Discovery & Design (**PASS 1–2 only**; GCC-E2E-009)
...
| `Recruiter_Hub_-_Candidates_for_a_Recruiter-844edbb8-6220-4780-9e42-563f45f90c1c.png` | **D** | **Candidate table** baseline — primary landing behind modal (v50) |
...
## CHECKPOINT (GCC E2E — 315 stopped after PASS 2)

**319-doc-writer** must review the **Copy Inventory** (section 2.5) against Editorial Guidelines; **060** for legal-sensitive lines (anonymisation, any AI stub). **315** then runs **PASS 3–4** and records **Final Verdict: APPROVED** or **NEEDS REVISION** before **320**.

**Final Verdict:** *(pending — do not hand to 320 until APPROVED)*

**Handoff to 320 (after approval):** implement `design/gcc-candidate-grid-redesign-v50.tsx` (or orchestrator-specified name) per approved copy and this brief.
