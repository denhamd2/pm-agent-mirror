...
const METRICS_INVENTORY: { category: string; name: string; description: string; source: string; dashboard: string }[] = [
  ...
  { category: 'Customer Scorecard', name: 'Feature-TTH Correlation (global)', description: 'Median TTH comparison: median(TTH_off) - median(TTH_on) per feature. Ranked by deltaTthDays. Pre-baked with Mann-Whitney U q-values, Benjamini-Hochberg adjusted.', source: 'IUM 2358 + PCA adoption', dashboard: 'Customer Scorecard' },
  { category: 'Customer Scorecard', name: 'Feature-TTH Correlation (filtered)', description: 'Same median comparison recomputed at runtime for segment/industry filters. Confidence capped at medium (no q-values recomputed).', source: 'IUM 2358 + PCA adoption + tenant_filters', dashboard: 'Customer Scorecard' },
